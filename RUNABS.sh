...
install() {
reset
echo -e "\e[38;5;77m • Welcome to Source feras - اهلا بك في سورس فراس •\e[0m"
echo -e "\e[38;5;77m      •{ Setting up offices - جاري رفع المكاتب } •\e[0m"
echo -e "\e[38;5;77m • Installing Source Feras - جاري تحميل سورس فراس •\e[0m"
...
reset
echo -e "\e[38;5;77m • Installing Source Fetas - جاري تحميل سورس فراس •\e[0m"
